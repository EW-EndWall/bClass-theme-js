<p align="center">
  <a href="https://bClass.bik.run/">
    <img src="./icon/bClass theme-js.svg" alt="Logo" width="220" height="auto">
  </a>
...
bClass-theme-css attachment library. A comprehensive library for developing interfaces to websites and applications.

> [!NOTE]
> It is developed to be used in [bik.run](https://bik.run) services and systems within the scope of bClass theme js [birlik project](https://project.birlik.run). You are free to use it under the license.
